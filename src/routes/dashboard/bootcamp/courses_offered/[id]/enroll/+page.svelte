<script lang="ts">
  ...
  const { course, employeeNames, remainingSlots, newEnrollment_ID, enrollees } =
    data;
...
<main class="w-full">
  ...
  <div class="grid grid-cols-2 gap-4">
    <div>
      <p>
        ...
        {course.Course_ID} <strong class="ml-4">Course Category:</strong>
        {course.Course_Category}
      </p>
      <p>
        <strong>Instructor:</strong>
        {course.Employee_FirstName}
        {course.Employee_LastName}
        <strong class="ml-4">Course Schedule:</strong>
  ...
  <form method="POST" class="mt-6">
    ...
    {:else}
      ...
      <button type="submit" class="mt-2 mb-2" style="color: gray;" disabled
        >Enroll</button
      >
    {/if}
