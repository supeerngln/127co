...
<main class="w-full">
  <Breadcrumb items={[{ href: "/dashboard/bootcamp", text: "Bootcamp" }]} />
  <!-- Employees -->
  <a
    href="/dashboard/bootcamp/courses_offered"
  ...
  >
    ...
    <div class="flex w-full flex-col h-full">
      ...
      <span class="text-subtext z-4">Show the list of courses offered.</span>
    </div>
