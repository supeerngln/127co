<script lang="ts">
  ...
  import { contractHeaders } from "$lib/headers";
...
<main class="w-full">
  <Breadcrumb
    items={[
      ...
      { href: `/dashboard/marketing/contract`, text: "Contract" },
    ]}
  />
  ...
  <Table primaryKey="Client_ID" headers={contractHeaders} rows={contract} />
</main>
